...
public class Dijkstra {
    ...
    public static void shortestPathBetween(Graph g, Vertex startingVertex, Vertex targetVertex, StringBuffer sb) {
        ...
        sb.append("Shortest Distance between " + startingVertex.getData() + " and " + targetVertex.getData());
        sb.append("\n");
        sb.append(distance);
        sb.append("\n");
    ...
    public static void main(String[] args){
        ...
        shortestPathBetween(testGraph, a, g, sb);
